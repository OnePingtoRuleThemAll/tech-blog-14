...
router.get("/", async (req, res) => {
    try {
        // find all post with associated usernames
    const postData = await Post.findAll({
        include: [{ model: User, attributes: ["username"] }],
    });
    //conver post data to plain Javascript object
...
// route to render dashboard page with all post by corrent user
// find all post by current user with associated usernames
